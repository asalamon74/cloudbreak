...
public enum EnvironmentStatus {
    ...
    UPGRADE_CCM_TUNNEL_UPDATE_IN_PROGRESS("Upgrading CCM tunnel type of the environment"),
    UPGRADE_CCM_TUNNEL_UPDATE_FAILED("Upgrading CCM tunnel type of the environment failed"),
